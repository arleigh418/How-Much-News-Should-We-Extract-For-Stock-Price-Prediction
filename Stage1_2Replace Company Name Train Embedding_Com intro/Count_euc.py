        ...
        for model_use in model_list:
            for per in percentage:
                ...
                for x in all_article:
                    ...
                    euc  = euclidean_sim(article_vec,article_center_vec)
                    score.append(euc)
                ...
                pd_concat.to_excel(f'../{fo}/All_File/{com_list_num[company]}TW_intro/euc/euc{str(100-int(per))}%_{model_use}_{com_list[company]}.xlsx')
