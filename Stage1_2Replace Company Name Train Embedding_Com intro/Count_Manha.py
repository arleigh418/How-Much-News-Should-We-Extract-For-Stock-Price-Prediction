        ...
        for model_use in model_list:
            for per in percentage:
                ...
                for x in all_article:
                    ...
                    Manhattan = Manhattan_sim(article_vec,article_center_vec)
                ...
                pd_concat.to_excel(f'../{fo}/All_File/{com_list_num[company]}TW_intro/manha/manha{str(100-int(per))}%_{model_use}_{com_list[company]}.xlsx')
