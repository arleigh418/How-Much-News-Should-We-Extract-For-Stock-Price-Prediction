        ...
        for model_use in model_list:
            for per in percentage:
                ...
                for x in all_article:
                    ...
                    cos  = cos_sim(article_vec,model.wv['{}'.format(com_list[company])])
                    score.append(cos)
                    # print(cos)
                ...
                pd_concat.to_excel(f'../{fo}/All_File/{com_list_num[company]}TW/cos/cos{str(100-int(per))}%_{model_use}_{com_list[company]}.xlsx')
